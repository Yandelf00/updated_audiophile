...
export default function ProductFeatures({features, includedItems} : featuresPropType) {
  return (
    <div className='w-full flex justify-center mt-[150px] pr-5 pl-5'>
        <div className='w-[1000px] flex flex-row sm:space-y-10 sm:flex-col justify-between'>
            <div className='flex sm:w-full flex-col w-[60%] space-y-5'>
                <h1 className='text-black font-bold text-[30px]'>FEATURES</h1>
                <p className='text-gray text-[13px]'>{features}</p>
            </div> 
            <div className='flex flex-col w-[25%] sm:w-full h-full space-y-3'>
